...
/* function mailcheck(){    //메일 선택하면 자동 체크
    i=document.frm.mail3.selectedIndex // 선택항목의 인덱스 번호
    var mail=document.frm.mail3.options[i].value // 선택항목 value
    document.frm.userEmail2.value=mail
   } */
...
<br /><br />
   <center />
      <h1>회원가입</h1><br />
      <form action ="MemberRegist.nhn" id="frm">      
      <input type="hidden" name = "confirmNum" id = "confirmNum" value="1">
         <table border="1" bgcolor="#cdfdee" cellspacing="1">   
            <tr>
               <td align="center">아이디</td>
               <td>
                  <input type="text" id="userId" name="userId"/> <input type ="button" name="userConfirm" id="userConfirm" value="중복확인">
               </td>
            </tr>
