...
<center/>
<form action="driverHireWritePro.dv" method="post"  name="driverhireform">
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
			<input name="DRIVER_HIRE_NAME" type="text" size="10" maxlength="10" value="관리자"/>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td colspan="5">
			<a href="javascript:addboard()" onclick="popclose();">[등록]</a>&nbsp;&nbsp;
